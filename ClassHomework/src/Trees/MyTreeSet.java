...
*/
  ...
  private class MyTreeSetIterator implements Iterator<Object>
  {
	...
	public void traverseInorder (TreeNode root, Stack s) {
	  if(root != null) {
		  traverseInorder(root.getLeft(), s);
		  s.push(root.getValue());
		  traverseInorder(root.getRight(), s);
	  }	  
  }
  }

...
public class BuggyDeckTester {
	...
	private static void test1CardDeck() {
		...
		String[] s1 = {"spades"};
		int[] v1 = {1};
		BuggyDeck d = new BuggyDeck(r1, s1, v1);
	...
	private static void test2CardDeck() {
		...
		String[] s2 = {"hearts"};
		int[] v2 = {1, 2};
		BuggyDeck d = new BuggyDeck(r2, s2, v2);
		...
		aceIsFirst = c.equalsCard(new Card("ace", "hearts", 1));
		twoIsFirst = c.equalsCard(new Card("2", "hearts", 2));
		...
		if (aceIsFirst) {
			assert c.equalsCard(new Card("2", "hearts", 2))	: "2nd card dealt is "
				+ c + ". It is not one of the two correct cards.";
		} else {
			assert c.equalsCard(new Card("ace", "hearts", 1)) : "2nd card dealt is "
				+ c + ". It is not one of the two correct cards.";
		}
		testEmpty(d);
		...
		if (aceIsFirst) {
			assert c.equalsCard(new Card("2", "hearts", 2))
				: "2nd card dealt after shuffle is " + c
				+ ". It is not the one of the two correct cards.";
		} else {
			assert c.equalsCard(new Card("ace", "hearts", 1))
				: "2nd card dealt after shuffle is " + c
				+ ". It is not the one of the two correct cards.";
		}
		testEmpty(d);
	 ...
	 */
	private static void testEmpty(BuggyDeck d) {
	 ...
	 */
	private static void testOneCard(BuggyDeck d, Card intended) {
		assert d.size() == 1 : "Size is " + d.size()
		...
		assert c.equalsCard(intended) : "1st card dealt for a 1-card deck is "
	...
	private static void testShuffle() {
		...
		BuggyDeck d1 = new BuggyDeck(r, s, v);
		BuggyDeck d2 = new BuggyDeck(r, s, v);
